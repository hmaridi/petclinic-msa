...
To use a MySQL database, you have to start 3 microservices (`visits-service`, `customer-service` and `vets-services`)
...
* `customer-service` application has the following custom metrics enabled:
